...
class Http
{
    protected static function ihttp_request($url, $post = '', $extra = array(), $timeout = 60) {
    ...
    protected static function ihttp_response_parse($data, $chunked = false) {
        $rlt = array();
    ...
    protected static function ihttp_response_parse_unchunk($str = null) {
     ...
     * @return 响应数据
     */
    public static function ihttp_post_json($url, $data) {
